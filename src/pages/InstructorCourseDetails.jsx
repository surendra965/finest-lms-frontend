            ...
            <div className="flex-1 min-w-0 lg:pr-8">
              ...
              <div className="flex items-center gap-4 text-[14px] mb-6 flex-wrap">
                ...
                <div className="flex items-center gap-3 text-[#cec0fc] text-[13px]">
                  ...
                  <span className="inline-flex items-center gap-1"><AiOutlineClockCircle size={16} className="text-[#cec0fc]" /> {course.totalDuration ?? 0} mins</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-5 border-t border-[#3e4143]">
                ...
                <button
                  onClick={() => navigate(`/instructor/courses/${id}/curriculum`)}
              ...
              <div className="border border-[#3e4143] lg:border-[#d1d7dc] rounded-lg overflow-hidden shadow-2xl bg-white">
                ...
                <div className="bg-white px-5 py-5 space-y-4">
                  <div className="flex items-baseline gap-2">
                    <span className="text-2xl font-extrabold text-[#1c1d1f]">₹{course.price}</span>
                    <span className="text-xs text-[#6a6f73]">course price</span>
                  </div>
                  ...
                  >
                    {publishing ? (
                      ...
                      <span className="inline-flex items-center gap-2 justify-center">
                        <AiOutlinePlusCircle size={18} /> Publish Course
                      </span>
                    )}
                  </button>
                  ...
                  <div className={`flex items-start gap-2.5 rounded px-3 py-2.5 text-xs
                    ${isPublished ? "bg-[#ecfdf5] text-[#065f46]" : "bg-[#fef9c3] text-[#854d0e]"}`}
                  >
                    <span className="text-base leading-none mt-0.5">
                      {isPublished ? <AiFillCheckCircle size={18} /> : <AiOutlineFileText size={18} />}
                    </span>
                    <p>
                      {isPublished
        ...
        <div className="max-w-[1180px] mx-auto px-6 pt-20 pb-12 grid lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            ...
            <div className="border border-[#d1d7dc] rounded-lg p-5">
              ...
              <InfoRow icon={<AiFillDollarCircle size={18} className="text-[#6a6f73]" />} label="Price"           value={`₹${course.price}`} />
              ...
              <InfoRow icon={<AiOutlineClockCircle size={18} className="text-[#6a6f73]" />} label="Duration"        value={course.totalDuration ? `${course.totalDuration} mins` : null} />
            ...
            <div className="border border-[#d1d7dc] rounded-lg p-5">
              ...
              <div className="space-y-0.5">
                {[
                  { label: "Edit course details",    icon: <AiOutlineEdit size={18} className="font-bold" />, onClick: () => navigate(`/instructor/course/${course._id}/edit`), style: "text-[#a435f0] hover:bg-[#f7f0ff]" },
                  { label: "Manage curriculum",      icon: <AiOutlineBook size={18} className="font-bold" />, onClick: () => navigate(`/instructor/courses/${id}/curriculum`), style: "text-[#1c1d1f] hover:bg-[#f7f9fa]" },
